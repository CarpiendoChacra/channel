...
async def wishper_ai(_, sz: InlineQuery):
    ...
    if query == '' or len(query) > lengths \
        ...
        content = ("**Send whisper messages through inline mode**\n\n"
                   "Usage: `@RUTotalSecurityBot [@username] text`")
        description = "Usage: @RUTotalSecurityBot [@username] text"
        button = InlineKeyboardButton(
            "More-Help",
            url="https://t.me/RUTotalSecurityBott?start=learn"
        )
...
example:- 
@RUTotalSecurityBot hello this is a test @supunma
