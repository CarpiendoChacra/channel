...
from TotalSecurity import app,BOT_ID,OWNER_ID,LOG_GROUP_ID
from TotalSecurity.mongo.gban import GBan
from TotalSecurity.mongo.usersdb import adds_served_user
from TotalSecurity.mongo.welcomedb import Greetings
from TotalSecurity.utils.custom_filters import admin_filter, command
...
from TotalSecurity.utils.filter_groups import cleanner,welcomes,leftwelcome
...
**New to Me, Touch the below button and start me in PM**
            ...
            [
                InlineKeyboardButton("quick start guide", url="http://t.me/RUTotalSecurityBot?start=help"),
            ]))
