...
from TotalSecurity.mongo.reportdb import Reporting
...
TotalSecurity will then reply with a message stating that admins have been notified. 
...
or when used to report an admin. TotalSecurity assumes that admins 
