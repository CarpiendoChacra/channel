...
from TotalSecurity import dbn,app
...
from TotalSecurity.mongo.usersdb import get_served_users,gets_served_users,remove_served_user
from TotalSecurity.mongo.chatsdb import get_served_chats
...
async def gstats(_, message):
    ...
    smex = f"""
** General Stats of TotalSecurity Bot**
