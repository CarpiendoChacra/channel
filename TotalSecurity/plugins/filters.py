...
from TotalSecurity.utils.cmd_senders import send_cmd
from TotalSecurity.utils.custom_filters import command, owner_filter
from TotalSecurity.utils.kbhelpers import rkb as ikb
from TotalSecurity.utils.msg_types import Types, get_filter_type
from TotalSecurity.utils.regex_utils import regex_searcher
...
from pyrogram import filters
from TotalSecurity.mongo.connectiondb import active_connection
from lang import get_command
from TotalSecurity.utils.lang import language
from TotalSecurity.utils.filter_groups import chat_filters_group
...
Filters are case insensitive; every time someone says your trigger words, TotalSecurity will reply something else! can be used to create your own commands, if desired.
