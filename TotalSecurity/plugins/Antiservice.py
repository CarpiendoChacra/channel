...
from TotalSecurity.mongo.antiservice import (
    antiservice_on,
    antiservice_off,
    is_antiservice
)
from TotalSecurity.utils.filter_groups import service
from lang import get_command
from pyrogram.types import Message
from TotalSecurity.utils.lang import language
from pyrogram.types import InlineKeyboardButton
from TotalSecurity.utils.custom_filters import can_change_filter
...
__HELP__ = f"""
**Formatting**
TotalSecurity supports a large number of formatting options to make
