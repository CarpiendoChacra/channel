...
from TotalSecurity.utils.filter_groups import spam,spoiler,channel,url,porn
from typing import Union
from TotalSecurity.plugins.protection import get_file_id
from TotalSecurity.mongo.approvedb import Approve 
from TotalSecurity import app as pbot,app
from TotalSecurity.core.decorators.permissions import list_admins,member_permissions
from TotalSecurity.plugins.lock import lockdb
