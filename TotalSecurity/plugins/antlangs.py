#====================================================================================================
# Copyright (c) 2023 Facu Glitch
#====================================================================================================

from pyrogram import filters
from pyrogram.types import Message
from re import search
from TotalSecurity import app as NEXAUB
from TotalSecurity.utils.custom_filters import admin_filter
from TotalSecurity import app
from TotalSecurity.mongo.antilang import (
    set_anti_func,
    del_anti_func,
    get_anti_func
)
...
from TotalSecurity.utils.filter_groups import antifunc_group
...
- TotalSecurity can mute members who are not subscribed your channel until they subscribe
