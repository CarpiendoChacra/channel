from TotalSecurity import bot as app
...
TotalSecurity supports a large number of formatting 
...
the user will be redirected to TotalSecurity's PM to see the note."""
...
This will randomly choose between sending the first message, "hello", or the second message, "how are you".
 Use this to make TotalSecurity feel a bit more customised! (only works in notes/filters/greetings)
